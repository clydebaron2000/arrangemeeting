...
//                             <span className="card-title">Clyde Baron Rapinan</span>
...
//                                 <h3 className="about-position">Full Stack Developer</h3>
//                                 <p className="about-me">I am god tier programmer. No questions needed, it's already done. Sham Wow!</p>
//                         </div>
//                     </div>
//                     </div>
...
//                         <div className="about-us">
//                             <h3 className="about-position">Full Stack Developer</h3>
//                             <p className="about-me">I have a mongo database connected to my twitter, and it looks like your girl keeps making requests to come into contact with me. </p>
//                         </div>
//                     </div>
//                     <div className="col">
//                         <div className="card text-center">
...
//                         <div className="about-us">
//                                 <h3 className="about-position">Full Stack Developer</h3>
//                                 <p className="about-me">I don't usually come back to the scene of the crime. But when I do, I'm usually dumping another body in this lake behind me.</p>
//                             </div>
//                     </div>
